...
(iii) Estimate the simple regression model $$log(salary) = \hat{\beta}_0 + \hat{\beta}_1 * ceoten + u$$,
...
$$sleep = \hat{\beta}_0 + \hat{\beta}_1 * totwrk + u$$,
...
(ii) In the population model $$math10 + \hat{\beta}_0 + \hat{\beta}_1 log(expend ) + u$$,
...
(iii) Estimate the model $$gift = \hat{\beta}_0 + \hat{\beta}_1 * mailsyear + u$$
...
(iii) Now generate the yi as $$y_i = 1 + 2x_i + u_i = \hat{\beta}_0 + \beta x_i + ui$$;
